...
U_lb = repmat([-24000 -4000 -750], Nc, 1); % lower bound
U_ub = repmat([24000 4000 750], Nc, 1); % upper bound
...
d_barrier = 0.06; % distance to barrier
global B_terminal_cost
B_terminal_cost = @(x) (d_barrier - norm(x([1, 4])-x_barrier));
