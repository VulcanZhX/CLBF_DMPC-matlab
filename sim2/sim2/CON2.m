...
nlcon =@(u2) nonlinear2(u2,u2s,x4,x5,x6,x4s,x5s,x6s,x1,x2,x3,Delta,interval,pred,F1,F2,Ff2,V2,kA,kB,EAR,EBR,dHA,dHB,Cp,T0,xA0);
%% Bounds (lb <= u <= ub)
% lb = [];
% ub = []
lb = [16.2e5-5e5]*ones(pred,1);
ub = [16.2e5+5e5]*ones(pred,1);
