...
nlcon =@(u3) nonlinear3(u3,u3s,x7,x8,x9,x7s,x8s,x9s,x4,x5,x6,Delta,interval,pred,F2,F3,FD,FR,V3,alA,alB,alC,Cp);
%% Bounds (lb <= u <= ub)
lb = [-12.6e5-5.5e5]*ones(pred,1);
ub = [12.6e5+5.5e5]*ones(pred,1);
